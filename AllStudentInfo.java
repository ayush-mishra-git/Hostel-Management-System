...
public class AllStudentInfo extends JFrame implements ActionListener {
    ...
    AllStudentInfo() {
        ...
        l1.setBounds(40,5,60,10);
        add(l1);
        
        JLabel l2 = new JLabel("AGE");
        l2.setBounds(140,5,60,10);
        add(l2);
        
        JLabel l3 = new JLabel("DOB");
        l3.setBounds(235,5,60,10);
        add(l3);
        ...
        l5.setBounds(415,5,60,10);
        add(l5);
        
        JLabel l6 = new JLabel("CONTACT NO.");
        l6.setBounds(500,5,90,10);
        add(l6);
        
        JLabel l7 = new JLabel("EMAIL");
        l7.setBounds(620,5,90,10);
        add(l7);
        
        JLabel l8 = new JLabel("AADHAR NO.");
        l8.setBounds(700,5,90,10);
        add(l8);
        
        JLabel l9 = new JLabel("ROOM");
        l9.setBounds(815,5,90,10);
        add(l9);
        
        JLabel l10 = new JLabel("FEES");
        l10.setBounds(915,5,90,10);
        add(l10);
