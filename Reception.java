...
public class Reception extends JFrame implements ActionListener {
    ...
    Reception() {
        ...
        b8 = new JButton("Search Employee");
        ...
        l1.setBounds(200,10,510,430);
        add(l1);
        
        getContentPane().setBackground(Color.white);
        
        setBounds(330,130,750,500);
        setLayout(null);
        setVisible(true);
